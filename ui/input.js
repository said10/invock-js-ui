        ...
        return `
            <desktop>
                <p>
                    ...
                    <input name="{{props.name|default}}" type="{{props.type|default:text}}" placeholder="{{props.placeholder|default}}" class="{{props.class_required}}" data-rule="{{props.rule|default:string}}" />
                </p>
            </desktop>
            <mobile>
